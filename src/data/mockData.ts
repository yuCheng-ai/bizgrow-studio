...
export const mockAgents: Agent[] = [
  ...
  },
  {
    ...
    executionLog: [
      ...
      '[15:30:05] 断言生效: 发现物料 M-102 (MCU控制板) 库存缺口达 -5000 units',
      '[15:30:10] 推理启动: 检索合格供应商库，命中 A厂, B厂',
      '[15:30:15] 策略回测: A厂质量靠谱但近期交期波动大；B厂报价低但产能满载',
      '[15:30:18] 生成方案: 智能分配 70% 份额给予A厂锁定交期，30% 份额给B厂对冲成本',
      '[15:30:20] 动作执行: 生成草拟采购建议单 PR-2026-008',
      '[15:30:22] 防御拦截: 触发规则【金额超 5000 需确认】，流程已挂起，等待人工介入。'
    ]
  },
  {
    id: 'ag_mfg_01',
